...
namespace urban_style_auto_regist
{
    public partial class Form1 : Form
    {
        ...
        private void BtnStart_Click(object sender, EventArgs e)
        {
            ...
            {
                DdmshuLoginAsync(shopInfo.ShopUrl, shopInfo.ShopId, shopInfo.ShopPw, shopInfo.ShopName);
            }
            else if (shopInfo.ShopName.Equals("girlsgoob", StringComparison.OrdinalIgnoreCase))
            {
                GirlsgoobLoginAsync(shopInfo.ShopUrl, shopInfo.ShopId, shopInfo.ShopPw, shopInfo.ShopName);
            }
            else
            {
